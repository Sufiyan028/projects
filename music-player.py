...
def Play():
    ...
    song=f'E:\Code clause projects\music player{song}'
...
def Previous():
    ...
    temp2=f'E:\Code clause projects\music player{temp2}'
...
def Next():
    ...
    temp=f'E:\Code clause projects\music player{temp}'
